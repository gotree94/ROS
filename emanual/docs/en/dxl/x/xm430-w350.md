...
|:-------:|:----------:|:------------------------------------------------|:------:|:------------------:|:--------------------------:|:---------------:|
|    0    |     2      | [Model Number](#model-number)                   |   R    |       1,020        |             -              |        -        |
...
|   44    |     4      | [Velocity Limit](#velocity-limit)               |   RW   |        200         |         0 ~ 1,023          | 0.229 [rev/min] |
...
The Present PWM(124) value indicates current PWM. For more details, please refer to the [Goal PWM(100)](#goal-pwm).
...
{% include en/dxl/drawing/x430_drawing.md %}
